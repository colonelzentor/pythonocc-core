...
%feature("shadow") IVtkOCC_SelectableObject::~IVtkOCC_SelectableObject %{
def __del__(self):
	try:
		self.thisown = False
...
%extend IVtkOCC_SelectableObject {
	Handle_IVtkOCC_SelectableObject GetHandle() {
	return *(Handle_IVtkOCC_SelectableObject*) &$self;
	}
};
...
%feature("shadow") Handle_IVtkOCC_SelectableObject::~Handle_IVtkOCC_SelectableObject %{
def __del__(self):
    try:
        self.thisown = False
        GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") IVtkOCC_Shape::~IVtkOCC_Shape %{
def __del__(self):
	try:
		self.thisown = False
		GarbageCollector.garbage.collect_object(self)
...
%extend IVtkOCC_Shape {
	Handle_IVtkOCC_Shape GetHandle() {
	return *(Handle_IVtkOCC_Shape*) &$self;
	}
};
...
%feature("shadow") Handle_IVtkOCC_Shape::~Handle_IVtkOCC_Shape %{
def __del__(self):
    try:
        self.thisown = False
        GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") IVtkOCC_ShapeMesher::~IVtkOCC_ShapeMesher %{
def __del__(self):
	try:
		self.thisown = False
		GarbageCollector.garbage.collect_object(self)
...
%extend IVtkOCC_ShapeMesher {
	Handle_IVtkOCC_ShapeMesher GetHandle() {
	return *(Handle_IVtkOCC_ShapeMesher*) &$self;
	}
};
...
%feature("shadow") Handle_IVtkOCC_ShapeMesher::~Handle_IVtkOCC_ShapeMesher %{
def __del__(self):
    try:
        self.thisown = False
        GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") IVtkOCC_ShapePickerAlgo::~IVtkOCC_ShapePickerAlgo %{
def __del__(self):
	try:
		self.thisown = False
		GarbageCollector.garbage.collect_object(self)
...
%extend IVtkOCC_ShapePickerAlgo {
	Handle_IVtkOCC_ShapePickerAlgo GetHandle() {
	return *(Handle_IVtkOCC_ShapePickerAlgo*) &$self;
	}
};
...
%feature("shadow") Handle_IVtkOCC_ShapePickerAlgo::~Handle_IVtkOCC_ShapePickerAlgo %{
def __del__(self):
    try:
        self.thisown = False
        GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") IVtkOCC_ViewerSelector::~IVtkOCC_ViewerSelector %{
def __del__(self):
	try:
		self.thisown = False
		GarbageCollector.garbage.collect_object(self)
...
%extend IVtkOCC_ViewerSelector {
	Handle_IVtkOCC_ViewerSelector GetHandle() {
	return *(Handle_IVtkOCC_ViewerSelector*) &$self;
	}
};
...
%feature("shadow") Handle_IVtkOCC_ViewerSelector::~Handle_IVtkOCC_ViewerSelector %{
def __del__(self):
    try:
        self.thisown = False
        GarbageCollector.garbage.collect_object(self)
