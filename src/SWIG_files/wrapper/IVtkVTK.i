...
%feature("shadow") IVtkVTK_ShapeData::~IVtkVTK_ShapeData %{
def __del__(self):
	try:
		self.thisown = False
...
%extend IVtkVTK_ShapeData {
	Handle_IVtkVTK_ShapeData GetHandle() {
	return *(Handle_IVtkVTK_ShapeData*) &$self;
	}
};
...
%feature("shadow") Handle_IVtkVTK_ShapeData::~Handle_IVtkVTK_ShapeData %{
def __del__(self):
    try:
        self.thisown = False
        GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") IVtkVTK_View::~IVtkVTK_View %{
def __del__(self):
	try:
		self.thisown = False
		GarbageCollector.garbage.collect_object(self)
...
%extend IVtkVTK_View {
	Handle_IVtkVTK_View GetHandle() {
	return *(Handle_IVtkVTK_View*) &$self;
	}
};
...
%feature("shadow") Handle_IVtkVTK_View::~Handle_IVtkVTK_View %{
def __del__(self):
    try:
        self.thisown = False
        GarbageCollector.garbage.collect_object(self)
