...
class Graphic3d_Buffer : public NCollection_Buffer {
	public:
		%feature("compactdefaultargs") Graphic3d_Buffer;
		%feature("autodoc", "	* Empty constructor.
	...
	:rtype: None
") Graphic3d_Buffer;
		 Graphic3d_Buffer (const Handle_NCollection_BaseAllocator & theAlloc);
		%feature("compactdefaultargs") AttributesArray;
		%feature("autodoc", "	* returns array of attributes definitions

	:rtype: Graphic3d_Attribute *
") AttributesArray;
		const Graphic3d_Attribute * AttributesArray ();
		%feature("compactdefaultargs") Attribute;
		%feature("autodoc", "	* returns attribute definition

	:param theAttribIndex:
	:type theAttribIndex: int
	:rtype: Graphic3d_Attribute
") Attribute;
		const Graphic3d_Attribute & Attribute (const Standard_Integer theAttribIndex);
		%feature("compactdefaultargs") ChangeAttribute;
		%feature("autodoc", "	* returns attribute definition
...
") ChangeAttribute;
		...
		%feature("compactdefaultargs") AttributeOffset;
		%feature("autodoc", "	* returns data offset to specified attribute

	:param theAttribIndex:
	:type theAttribIndex: int
	:rtype: int
") AttributeOffset;
		Standard_Integer AttributeOffset (const Standard_Integer theAttribIndex);
		%feature("compactdefaultargs") Data;
		%feature("autodoc", "	* returns data for specified attribute

	:param theAttribIndex:
	:type theAttribIndex: int
	:rtype: Standard_Byte *
") Data;
		const Standard_Byte * Data (const Standard_Integer theAttribIndex);
...
") ChangeData;
		...
		%feature("compactdefaultargs") value;
		%feature("autodoc", "	* Access specified element.

	:param theElem:
	:type theElem: int
	:rtype: inline  Standard_Byte *
") value;
		inline const Standard_Byte * value (const Standard_Integer theElem);
		%feature("compactdefaultargs") changeValue;
		%feature("autodoc", "	* Access specified element.
...
") changeValue;
		...
		%feature("autodoc", "	* Release buffer.
...
%feature("shadow") Graphic3d_Buffer::~Graphic3d_Buffer %{
def __del__(self):
	try:
		self.thisown = False
		GarbageCollector.garbage.collect_object(self)
...
class Graphic3d_IndexBuffer : public Graphic3d_Buffer {
	public:
		%feature("compactdefaultargs") Graphic3d_IndexBuffer;
		%feature("autodoc", "	* Empty constructor.
...
") Graphic3d_IndexBuffer;
		 Graphic3d_IndexBuffer (const Handle_NCollection_BaseAllocator & theAlloc);
...
%feature("shadow") Graphic3d_IndexBuffer::~Graphic3d_IndexBuffer %{
def __del__(self):
	try:
		self.thisown = False
		GarbageCollector.garbage.collect_object(self)
