...
") ChangeSequence;
		...
		%feature("autodoc", "	:rtype: Handle_Visual3d_HSequenceOfLight
") ShallowCopy;
		Handle_Visual3d_HSequenceOfLight ShallowCopy ();
};
...
") ChangeSequence;
		...
		%feature("compactdefaultargs") ShallowCopy;
		%feature("autodoc", "	:rtype: Handle_Visual3d_HSequenceOfView
") ShallowCopy;
		Handle_Visual3d_HSequenceOfView ShallowCopy ();
};
