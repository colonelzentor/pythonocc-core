...
%feature("shadow") IVtkTools_ShapeDataSource::~IVtkTools_ShapeDataSource %{
def __del__(self):
	try:
		self.thisown = False
...
%feature("shadow") IVtkTools_ShapeObject::~IVtkTools_ShapeObject %{
def __del__(self):
	try:
		self.thisown = False
		GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") IVtkTools_ShapePicker::~IVtkTools_ShapePicker %{
def __del__(self):
	try:
		self.thisown = False
		GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") IVtkTools_SubPolyDataFilter::~IVtkTools_SubPolyDataFilter %{
def __del__(self):
	try:
		self.thisown = False
		GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") IVtkTools_DisplayModeFilter::~IVtkTools_DisplayModeFilter %{
def __del__(self):
	try:
		self.thisown = False
		GarbageCollector.garbage.collect_object(self)
