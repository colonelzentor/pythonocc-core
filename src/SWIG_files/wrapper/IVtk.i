...
%feature("shadow") IVtk_Interface::~IVtk_Interface %{
def __del__(self):
	try:
		self.thisown = False
...
%extend IVtk_Interface {
	Handle_IVtk_Interface GetHandle() {
	return *(Handle_IVtk_Interface*) &$self;
	}
};

%nodefaultctor Handle_IVtk_Interface;
class Handle_IVtk_Interface : public Handle_Standard_Transient {

    public:
        // constructors
        Handle_IVtk_Interface();
        Handle_IVtk_Interface(const Handle_IVtk_Interface &aHandle);
        Handle_IVtk_Interface(const IVtk_Interface *anItem);
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IVtk_Interface DownCast(const Handle_Standard_Transient &AnObject);

};
%extend Handle_IVtk_Interface {
    IVtk_Interface* GetObject() {
    return (IVtk_Interface*)$self->Access();
    }
};
%feature("shadow") Handle_IVtk_Interface::~Handle_IVtk_Interface %{
def __del__(self):
    try:
        self.thisown = False
        GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") IVtk_IShape::~IVtk_IShape %{
def __del__(self):
	try:
		self.thisown = False
		GarbageCollector.garbage.collect_object(self)
...
%extend IVtk_IShape {
	Handle_IVtk_IShape GetHandle() {
	return *(Handle_IVtk_IShape*) &$self;
	}
};

%nodefaultctor Handle_IVtk_IShape;
class Handle_IVtk_IShape : public Handle_IVtk_Interface {

    public:
        // constructors
        Handle_IVtk_IShape();
        Handle_IVtk_IShape(const Handle_IVtk_IShape &aHandle);
        Handle_IVtk_IShape(const IVtk_IShape *anItem);
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IVtk_IShape DownCast(const Handle_Standard_Transient &AnObject);

};
%extend Handle_IVtk_IShape {
    IVtk_IShape* GetObject() {
    return (IVtk_IShape*)$self->Access();
    }
};
%feature("shadow") Handle_IVtk_IShape::~Handle_IVtk_IShape %{
def __del__(self):
    try:
        self.thisown = False
        GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") IVtk_IShapeData::~IVtk_IShapeData %{
def __del__(self):
	try:
		self.thisown = False
		GarbageCollector.garbage.collect_object(self)
...
%extend IVtk_IShapeData {
	Handle_IVtk_IShapeData GetHandle() {
	return *(Handle_IVtk_IShapeData*) &$self;
	}
};

%nodefaultctor Handle_IVtk_IShapeData;
class Handle_IVtk_IShapeData : public Handle_IVtk_Interface {

    public:
        // constructors
        Handle_IVtk_IShapeData();
        Handle_IVtk_IShapeData(const Handle_IVtk_IShapeData &aHandle);
        Handle_IVtk_IShapeData(const IVtk_IShapeData *anItem);
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IVtk_IShapeData DownCast(const Handle_Standard_Transient &AnObject);

};
%extend Handle_IVtk_IShapeData {
    IVtk_IShapeData* GetObject() {
    return (IVtk_IShapeData*)$self->Access();
    }
};
%feature("shadow") Handle_IVtk_IShapeData::~Handle_IVtk_IShapeData %{
def __del__(self):
    try:
        self.thisown = False
        GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") IVtk_IShapeMesher::~IVtk_IShapeMesher %{
def __del__(self):
	try:
		self.thisown = False
		GarbageCollector.garbage.collect_object(self)
...
%extend IVtk_IShapeMesher {
	Handle_IVtk_IShapeMesher GetHandle() {
	return *(Handle_IVtk_IShapeMesher*) &$self;
	}
};

%nodefaultctor Handle_IVtk_IShapeMesher;
class Handle_IVtk_IShapeMesher : public Handle_IVtk_Interface {

    public:
        // constructors
        Handle_IVtk_IShapeMesher();
        Handle_IVtk_IShapeMesher(const Handle_IVtk_IShapeMesher &aHandle);
        Handle_IVtk_IShapeMesher(const IVtk_IShapeMesher *anItem);
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IVtk_IShapeMesher DownCast(const Handle_Standard_Transient &AnObject);

};
%extend Handle_IVtk_IShapeMesher {
    IVtk_IShapeMesher* GetObject() {
    return (IVtk_IShapeMesher*)$self->Access();
    }
};
%feature("shadow") Handle_IVtk_IShapeMesher::~Handle_IVtk_IShapeMesher %{
def __del__(self):
    try:
        self.thisown = False
        GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") IVtk_IShapePickerAlgo::~IVtk_IShapePickerAlgo %{
def __del__(self):
	try:
		self.thisown = False
		GarbageCollector.garbage.collect_object(self)
...
%extend IVtk_IShapePickerAlgo {
	Handle_IVtk_IShapePickerAlgo GetHandle() {
	return *(Handle_IVtk_IShapePickerAlgo*) &$self;
	}
};

%nodefaultctor Handle_IVtk_IShapePickerAlgo;
class Handle_IVtk_IShapePickerAlgo : public Handle_IVtk_Interface {

    public:
        // constructors
        Handle_IVtk_IShapePickerAlgo();
        Handle_IVtk_IShapePickerAlgo(const Handle_IVtk_IShapePickerAlgo &aHandle);
        Handle_IVtk_IShapePickerAlgo(const IVtk_IShapePickerAlgo *anItem);
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IVtk_IShapePickerAlgo DownCast(const Handle_Standard_Transient &AnObject);

};
%extend Handle_IVtk_IShapePickerAlgo {
    IVtk_IShapePickerAlgo* GetObject() {
    return (IVtk_IShapePickerAlgo*)$self->Access();
    }
};
%feature("shadow") Handle_IVtk_IShapePickerAlgo::~Handle_IVtk_IShapePickerAlgo %{
def __del__(self):
    try:
        self.thisown = False
        GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") IVtk_IView::~IVtk_IView %{
def __del__(self):
	try:
		self.thisown = False
		GarbageCollector.garbage.collect_object(self)
...
%extend IVtk_IView {
	Handle_IVtk_IView GetHandle() {
	return *(Handle_IVtk_IView*) &$self;
	}
};

%nodefaultctor Handle_IVtk_IView;
class Handle_IVtk_IView : public Handle_IVtk_Interface {

    public:
        // constructors
        Handle_IVtk_IView();
        Handle_IVtk_IView(const Handle_IVtk_IView &aHandle);
        Handle_IVtk_IView(const IVtk_IView *anItem);
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IVtk_IView DownCast(const Handle_Standard_Transient &AnObject);

};
%extend Handle_IVtk_IView {
    IVtk_IView* GetObject() {
    return (IVtk_IView*)$self->Access();
    }
};
%feature("shadow") Handle_IVtk_IView::~Handle_IVtk_IView %{
def __del__(self):
    try:
        self.thisown = False
        GarbageCollector.garbage.collect_object(self)
